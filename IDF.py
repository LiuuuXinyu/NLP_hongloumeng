...
class featureVector:
    ...
    def count_words(self):
        ...
        file_out = open('E:\\forpython\\红楼梦-词频.txt','a',encoding = 'utf-8')
    ...
    def get_featureVector(self):
        ...
        temp = open('E:\\forpython\\红楼梦-词.txt','r',encoding = 'utf-8')
        word_beg = temp.read()
        ...
        cleanwords_dict = {k:v for k, v in cleanwords_dict.items() if v >= 120}

        cleanwords_f = list(cleanwords_dict.keys())

        xuci = open('E:\\forpython\\文言虚词.txt','r',encoding = 'utf-8')
