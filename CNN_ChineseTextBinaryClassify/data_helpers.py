...
def load_single_file(tojudge_file):
    jisuanji_examples = list(open(tojudge_file, "r", encoding="utf-8").readlines())
    #jisuanji_examples = list(open(jisuanji_data_file, "r", encoding="gb18030").readlines())
    jisuanji_examples = [s.strip() for s in jisuanji_examples]


    x_text = jisuanji_examples
...
def load_data_and_labels(jisuanji_data_file, jiaotong_data_file):
    ...
    #jiaotong_exampless = list(open(jiaotong_data_file, "r", encoding="gb18030").readlines())
